...
else if( isAdmin() || isStaff() )
{
	if ( isset($_GET['viewByUser']) )
	{
		...
		{
			$xml = $client->send( "COMMAND LOOKUP HISTORY user_id=$user_id" );
		}
	}
	...
	else if ( isset($_GET['viewByBook']) )
	{
		...
		else
		{
			...
			$xml = $client->send( "COMMAND LOOKUP HISTORY book_id=$book->book_id" );
		}
	}
	
	else if ( isset($_GET['viewAll']) )
	{
		$xml = $client->send( "COMMAND LOOKUP HISTORY ALL" );
	}
	
?>

<div class="menubox" >
<div class="menuboxheader" >History List</div>
