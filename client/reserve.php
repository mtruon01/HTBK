...
else if( isAdmin() || isStaff() )
{
	if ( isset($_GET['viewByUser']) )
	{
		...
		{
			$xml = $client->send( "COMMAND LOOKUP RESERVED user_id=$user_id" );
		}
	}
	...
	else if ( isset($_GET['viewByBook']) )
	{
		...
		else
		{
			...
			$xml = $client->send( "COMMAND LOOKUP RESERVED book_id=$book->book_id" );
		}
	}
	
	else if ( isset($_GET['viewAll']) )
	{
		$xml = $client->send( "COMMAND LOOKUP RESERVED ALL" );
	}
	
?>

<div class="menubox" >
<div class="menuboxheader" >Reserved List</div>
	
<div class="menuboxcontent" >

<td>
	<form align= "center" action="reserve.php" method="get">
	<tr>User ID</tr>
